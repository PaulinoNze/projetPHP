...
<body class="img js-fullheight" style="background-image: url(../bookPackage/images/bg.jpg);">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <form action="loginauth.php" method="POST" class="signin-form">
    ...
    <div class="form-group">
        <button type="submit" class="form-control btn btn-primary submit px-3" style="background-color: blue;">Sign In</button>
    </div>
    ...
    <script src="../bookPackage/js/jquery.min.js"></script>
    <script src="../bookPackage/js/popper.js"></script>
    <script src="../bookPackage/js/bootstrap.min.js"></script>
    <script src="../bookPackage/js/main.js"></script>
